...
The standard data directory used for docker is /var/lib/docker, and since this directory will store a lot of data it can become quite large.

Therefore we move the docker data directory to our volumne mnt/vdb.
